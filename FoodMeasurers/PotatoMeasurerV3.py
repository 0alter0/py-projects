...
potato_rupture_force_newtons = 648
...
while True:
    try:
        watts_or_length = input("What would you like to measure? [watts/length/radioactivity/mass/rupture force/volume] ").lower()
        ...
        elif watts_or_length == "rupture force":
