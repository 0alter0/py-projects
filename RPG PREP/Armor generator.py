...
item_type = ["Helmet","Boots","Chestplate","Bracelet","Ring","Leggings"]
    ...
    if action == "new":
        while True:
            ...
            if roll == "y":
                ...
                print()
                print(f"Item: {material} {atype}")
                print()
                print(f"Full Name: {' '.join(chosen_modifiers)} {material} {atype} ({rarity})")
                print()
